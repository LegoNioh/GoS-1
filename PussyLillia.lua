...
do
    ...
    local Files = {
        Lua = {
            ...
            Url = "https://raw.githubusercontent.com/LegoNioh/GoS-1/master/PussyLillia.lua"
        },
        Version = {
            Path = SCRIPT_PATH,
            Name = "PussyLillia.version",
            Url = "https://raw.githubusercontent.com/LegoNioh/GoS-1/master/PussyLillia.version"
        }
    }
