...
do
    ...
    local Files = {
        Lua = {
            ...
            Url = "https://raw.githubusercontent.com/LegoNioh/GoS-1/master/14Yasuo_Vol2.lua"
        },
        Version = {
            Path = SCRIPT_PATH,
            Name = "14Yasuo_Vol2.version",
            Url = "https://raw.githubusercontent.com/LegoNioh/GoS-1/master/14Yasuo_Vol2.version"
        }
    }
